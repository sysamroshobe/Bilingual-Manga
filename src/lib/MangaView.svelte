...
<div id="mainimagec" style="background:url({cdncdn}/{ll.coveren}) no-repeat; background-size: cover;background-position: center;" >
<img src="{cdncdn}/{ll.coveren}" alt="{ll.coveren}" id="mainimage"/>
<div id="spreads" ></div>
...
<div id="mainimagec" style="background:url({cdncdn}/{ll.coverjp}) no-repeat; background-size: cover;background-position: center;" >
<img src="{cdncdn}/{ll.coverjp}" alt="{ll.coverjp}" id="mainimage"/>
<div id="spreads" ></div>
